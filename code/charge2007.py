...
def train_feature_to_file(start,end,cutoff,filtration0,filtration1,grid):
        ...
        for P in range(5):
            for L in range(10):
                ...
                if eigenvalue0[0]==-1:
                    ...
                    #number0 = 2
                    for ii in range(1,1+number0,add_value):
                        value = []
                        c0 = 0
                ...
                if eigenvalue1[0]==-1:
                    ...
                    for ii in range(1,1+number1,add_value):
    ...
    filename = pre + 'pocket_feature/charge_laplacian_train_50_10_10_' + str(grid) + '.csv'
...
def test_feature_to_file(start,end,cutoff,filtration0,filtration1,grid):
    ...
    filename = pre + 'pocket_feature/charge_laplacian_test_50_10_10_' + str(grid) + '.csv'
    np.savetxt(filename,feature_matrix,delimiter=',')
...
def get_pearson_correlation(typ,pref):
    feature_matrix_of_train1 = np.loadtxt( pre + '/pocket_feature/' + pref +'charge_laplacian_train_50_10_10_0.02.csv',delimiter=',' )
    target_matrix_of_train1 = np.loadtxt( pre + '/pocket_feature/' + 'target_matrix_of_train.csv',delimiter=',' )
    feature_matrix_of_test1 = np.loadtxt( pre + '/pocket_feature/' + pref + 'charge_laplacian_test_50_10_10_0.02.csv',delimiter=',' )
    target_matrix_of_test1 = np.loadtxt( pre + '/pocket_feature/' +  'target_matrix_of_test.csv',delimiter=',' )
    
    feature_matrix_of_train = np.round(feature_matrix_of_train1,4)
    target_matrix_of_train = np.round(target_matrix_of_train1,4)
    feature_matrix_of_test = np.round(feature_matrix_of_test1,4)
    target_matrix_of_test = np.round(target_matrix_of_test1,4)
...
def run_for_PDBbind_2007():
    ...
    # feature generation
    train_feature_to_file(0,1105,10,10,10,0.02)
    test_feature_to_file(0,195,10,10,10,0.02)
