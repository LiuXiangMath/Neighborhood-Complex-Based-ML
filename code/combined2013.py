...
def get_pearson_correlation(typ,pref):
    pre = '../data/' + Year
    feature_matrix_of_train1 = np.loadtxt( pre + '/pocket_feature/' + pref +'mix_dis_and_charge_laplacian_train_50_10_10_0.02.csv',delimiter=',' )
    target_matrix_of_train1 = np.loadtxt( pre + '/pocket_feature/' + 'target_matrix_of_train.csv',delimiter=',' )
    feature_matrix_of_test1 = np.loadtxt( pre + '/pocket_feature/' + pref + 'mix_dis_and_charge_laplacian_test_50_10_10_0.02.csv',delimiter=',' )
...
get_pearson_correlation('combined','')
