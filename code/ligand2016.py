...
def run_for_PDBbind_2016():
    ##############################################################
    '''
    by running this function, you can get the ligand feature for PDB2016
    '''
    ##############################################################
    
    
    # extract coordinate
    extract_coordinate_of_ligand(0,4057)
    
    # create neighborhood complex and compute the spectral information
    eigenvalue_to_file(0,0,4057,10,0.1)
    eigenvalue_to_file(1,0,4057,5,0.1)
    
    # feature generation
    train_feature_to_file(0,3772,10,5,0.1)
    test_feature_to_file(0,285,10,5,0.1)
