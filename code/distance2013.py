...
def train_feature_to_file(start,end,cutoff,filtration0,filtration1,grid):
    ...
    pre1 = pre + 'eigenvalue_10_10_zero/' 
    ...
    filename = pre + '/pocket_feature/laplacian_train_10_10_0.1.csv'
...
def test_feature_to_file(start,end,cutoff,filtration0,filtration1,grid):
    ...
    filename = pre + 'pocket_feature/laplacian_test_10_10_0.1.csv'
    np.savetxt(filename,feature_matrix,delimiter=',')
...
def get_pearson_correlation(typ,pref):
    feature_matrix_of_train1 = np.loadtxt( pre + '/pocket_feature/' + pref +'laplacian_train_10_10_0.1.csv',delimiter=',' )
    target_matrix_of_train1 = np.loadtxt( pre + '/pocket_feature/' + 'target_matrix_of_train.csv',delimiter=',' )
    feature_matrix_of_test1 = np.loadtxt( pre + '/pocket_feature/' + pref + 'laplacian_test_10_10_0.1.csv',delimiter=',' )
...
def run_for_PDBbind_2013():
    ...
    # feature generation
    train_feature_to_file(0,2764,10,10,10,0.1)
    test_feature_to_file(0,195,10,10,10,0.1)
